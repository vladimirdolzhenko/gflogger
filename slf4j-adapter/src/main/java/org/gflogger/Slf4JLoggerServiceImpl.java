...
public class Slf4JLoggerServiceImpl extends LoggerServiceImpl {
    ...
    public Slf4JLoggerServiceImpl(int count, int maxMessageSize, GFLoggerBuilder[] loggerBuilders, AppenderFactory... appenderFactories) {
        super(count, maxMessageSize, loggerBuilders, appenderFactories);
    }

    public Slf4JLoggerServiceImpl(int count, int maxMessageSize, ObjectFormatterFactory objectFormatterFactory, GFLoggerBuilder[] loggersBuilders, AppenderFactory... appenderFactories) {
