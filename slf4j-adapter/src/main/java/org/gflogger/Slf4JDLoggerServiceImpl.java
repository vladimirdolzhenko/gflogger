...
public class Slf4JDLoggerServiceImpl extends LoggerServiceImpl {
    ...
    public Slf4JDLoggerServiceImpl(int count, int maxMessageSize, GFLoggerBuilder[] loggerBuilders, AppenderFactory... appenderFactories) {
        super(count, maxMessageSize, loggerBuilders, appenderFactories);
    }

    public Slf4JDLoggerServiceImpl(int count, int maxMessageSize, ObjectFormatterFactory objectFormatterFactory, GFLoggerBuilder[] loggersBuilders, AppenderFactory... appenderFactories) {
