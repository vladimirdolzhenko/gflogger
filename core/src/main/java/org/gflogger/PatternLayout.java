 ...
 *
 * <p>
 * <b>WARNING</b> Generating caller location information is extremely slow. It's
 * use should be avoided unless execution speed is not an issue.
 *
 * </tr>
 *
 ...
 * <em>extremely</em> slow. It's use should be avoided unless execution speed is
 * not an issue.
 *
 * </td>
 * </tr>
...
public class PatternLayout extends Layout {
	...
	public PatternLayout(final String pattern, final String timeZoneId, final String language) {
		this(pattern,
			timeZoneId != null ? TimeZone.getTimeZone(timeZoneId) : null,
			language != null ? new Locale(language) : null);
	}
	...
	protected PatternParser createPatternParser(final String pattern) {
		return new PatternParser(pattern, locale, timeZone);
	}
	 ...
	 */
	@Override
	public CharBuffer format(final CharBuffer buffer, final LogEntryItem item) {
